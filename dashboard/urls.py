...
urlpatterns = [
    path('', views.redirect_to_dashboard, name='home'),  # Root URL redirects to dashboard
    ...
    path('data/<str:format>/', views.get_data, name='get_data'),
    path('products/<str:format>/', views.get_products, name='get_products'),
]
